...
app = Flask(__name__,
static_folder = "D:\hypertension\frontend\dist\static",
template_folder = "D:\hypertension\frontend\dist")
...
##    print("str_attr")
##    print(str_attr)
##    match_str = "MATCH (p:" + start_node['type'] + "{name:\"" + start_node['name'] +"\"})-[r:" + relation['name'] + str_attr + "]->(q:" + end_node['type'] + "{name:\"" + end_node['name'] + "\"}) RETURN r"
...
##    #不存在，创建neo4j关系
##    else:
##        create_str = "MATCH (p:" + start_node['type'] + "{name:\"" + start_node['name'] +"\"}),(q:" + end_node['type'] + "{name:\"" + end_node['name'] + "\"}) CREATE (p)-[r:" + relation['name'] + str_attr + "]->(q) RETURN r"
##        print(create_str)
