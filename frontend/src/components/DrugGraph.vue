    ...
    <div>
        <div class='breadcrumb'>
            <el-breadcrumb separator="/" class="bc">
                ...
                <el-breadcrumb-item>药品知识图谱</el-breadcrumb-item>
...
export default {
    ...
    methods:{
        drawChart(searchVal){
            ...
            const path = `http://localhost:5000/graph/query/drug`
            axios
            .get(path,{params:{
                table:'drug',
                msg: searchVal
                ...
                tooltip:{
                    formatter: function(x) {
                        if (x.data.category != undefined){
                            ...
                            }else if(x.data.category == 3){
                                return '药品：'+x.data.name;
                            }
                            else{
