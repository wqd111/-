    ...
    <div>
        ...
        <div id='disease_table'>
            ...
            :data="tableData" heigt="500" border style="width:85%">
                ...
                <el-table-column prop="name" label="药品名称" width="135"></el-table-column>
                <el-table-column prop="element" label="成份" width="150"></el-table-column>
                <el-table-column prop="atc" label="ATC编码" width="135"></el-table-column>
                <el-table-column prop="usage" label="用法用量" width="200"></el-table-column>
                <el-table-column prop="unto" label="不良反应" width="200"></el-table-column>
